  ...
  return (
    <div className="h-[52px] bg-white border-t border-[#E5E7EB] px-5 flex items-center justify-between shrink-0">
      <button
        onClick={onPrevious}
        disabled={isFirst}
        className={`flex items-center gap-1.5 px-3 py-1.5 border border-[#E5E7EB] rounded-lg text-[12px] transition-colors cursor-pointer ${isFirst ? 'opacity-40 cursor-not-allowed text-[#9CA3AF]' : 'text-[#4B5563] hover:bg-[#F8F9FA]'}`}
      >
