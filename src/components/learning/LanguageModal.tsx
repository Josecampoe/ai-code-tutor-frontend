...
export function LanguageModal({ isOpen, selectedLanguage, onLanguageChange, onConfirm, onClose }: Props) {
  useEffect(() => {
    if (!isOpen) return;
          ...
          {LANGUAGES.map(lang => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center py-[7px] px-2 rounded-lg border cursor-pointer transition-colors ${
                  isSelected
