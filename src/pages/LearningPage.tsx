...
export function LearningPage() {
  ...
  const handleNext = () => {
    ...
    const sects = parseSections(currentLesson);
    setCurrentSectionIndex(prev => Math.min(sects.length - 1, prev + 1));
    scrollRef.current?.scrollTo({ top: 0, behavior: 'smooth' });
  };
    ...
    <div className="h-screen flex overflow-hidden bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-2">
            {selectedTopic && !isLanguageTopic && (
              <div className="flex items-center gap-1.5">
                ...
                <button
                  onClick={() => { setPendingTopic(selectedTopic); setIsLanguageModalOpen(true); }}
        ...
        {currentLesson && !isLoadingLesson && (
          <div className="h-[52px] bg-white border-t border-[#E5E7EB] px-5 flex items-center justify-between shrink-0">
            ...
            <span className="text-[11px] text-[#9CA3AF]">{currentSectionIndex + 1} / {sections.length}</span>
      ...
      {isLanguageModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-[300px] bg-white rounded-xl p-5 shadow-xl">
            ...
            <p className="text-[12px] text-[#4B5563] leading-[1.5] mb-3.5">
              Examples in this lesson will be shown in the language you pick.
            </p>
              ...
              {LANGUAGE_OPTIONS.map(lang => {
                ...
                return (
                  <button
                    ...
                    className={`py-[7px] px-2 rounded-lg border cursor-pointer transition-colors text-[11px] font-medium ${
                      isSelected
            ...
            <button
              onClick={handleLanguageModalConfirm}
              className="w-full bg-[#534AB7] text-white rounded-lg py-2 text-[12px] font-medium hover:opacity-90 transition-opacity cursor-pointer"
            >
              Start lesson →
            </button>
          </div>
